...
// milestone-close SHA (V114 = 7d922a7, see _lib/frozen-at-close.mjs MILESTONE_CLOSE_SHAS for the
// pin) instead of live HEAD. v1.14 is already green at live HEAD (Phase 133 TOOL-04 re-pinned its
// sidecar to live coordinates); this conversion removes that live-HEAD coupling, not a repair.
const MILESTONE_TAG = 'V114';
const SIDECAR_PATH = 'scripts/validation/v1.14-audit-allowlist.json'; // UNCHANGED literal -- GOV-02
