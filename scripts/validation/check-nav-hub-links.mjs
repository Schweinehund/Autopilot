...
// LINK-05 (Phase 143, D-16/D-21): ` {0,3}` leading allowance = CommonMark indented-fence rule; this is the reference instance the other 14 fence-mask sites copy verbatim.
