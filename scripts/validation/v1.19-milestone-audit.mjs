...
// Sidecar allow-list: scripts/validation/v1.19-audit-allowlist.json (v1.19 Path-A from v1.18 — header-fields-only copy [generated + phase], all 59 line-pins across 5 arrays carried forward byte-identical; pin validity proven by the sidecar-derived pinned-file-set × `git diff --name-only 7af8a147..HEAD -- docs scripts .github` intersection, which covers all 59 pins — NOT via `regenerate-supervision-pins.mjs --report`, which hardcodes the v1.7 sidecar and walks only 26 of 59 pins (correction of record: the predecessor header's claim that `--report` positively confirmed zero pin drift could not have proven what it claimed; see 138-CONTEXT.md D-20); no HYG-02-class line-shift event occurred this milestone)
