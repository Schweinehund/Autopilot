...
// milestone-close SHA (V112 = 12f2c7b, see _lib/frozen-at-close.mjs MILESTONE_CLOSE_SHAS for the
// pin) instead of live HEAD, resolving the frozen-vs-evolved freshness mismatch.
const MILESTONE_TAG = 'V112';
const SIDECAR_PATH = 'scripts/validation/v1.12-audit-allowlist.json'; // UNCHANGED literal -- GOV-02
