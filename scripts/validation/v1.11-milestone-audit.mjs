...
// milestone-close SHA (V111 = 919b23b, see _lib/frozen-at-close.mjs MILESTONE_CLOSE_SHAS for the
// pin) instead of live HEAD, resolving the frozen-vs-evolved freshness mismatch.
const MILESTONE_TAG = 'V111';
const SIDECAR_PATH = 'scripts/validation/v1.11-audit-allowlist.json'; // UNCHANGED literal -- GOV-02
