...
// milestone-close SHA (V141 = 5c976ec, see _lib/frozen-at-close.mjs MILESTONE_CLOSE_SHAS for the
// pin) instead of live HEAD, resolving the frozen-vs-evolved freshness mismatch.
const MILESTONE_TAG = 'V141';
const SIDECAR_PATH = 'scripts/validation/v1.4.1-audit-allowlist.json'; // UNCHANGED literal -- GOV-02
