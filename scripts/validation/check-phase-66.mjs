...
// Phases with known pre-existing failures that predate Plan 66-01 and are NOT regressions
// introduced by Phase 66 changes. These are skipped (not failed) in the chain regression-guard
// to prevent cascading false negatives.
//
// Pre-existing failure root causes (documented for v1.7 CI-Linux job resolution):
