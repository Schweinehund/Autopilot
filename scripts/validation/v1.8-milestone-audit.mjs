...
//   C16: 4-edge cross-link integrity triangle (BLOCKING from Phase 62 D-A9)
//
// Usage: node scripts/validation/v1.8-milestone-audit.mjs [--verbose] [--self-test]
...
// milestone-close SHA (V18 = 2bd79d8, see _lib/frozen-at-close.mjs MILESTONE_CLOSE_SHAS for the
// pin) instead of live HEAD, resolving the frozen-vs-evolved freshness mismatch.
const MILESTONE_TAG = 'V18';
const SIDECAR_PATH = 'scripts/validation/v1.8-audit-allowlist.json'; // UNCHANGED literal -- GOV-02
