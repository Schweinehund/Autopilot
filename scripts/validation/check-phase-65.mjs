...
// Phases with known pre-existing failures that predate Plan 65-01 and are NOT regressions
// introduced by Phase 65 changes. These are skipped (not failed) in the chain regression-guard
// to prevent cascading false negatives.
//
...
//
// Phase 65 adds NO new entries; all Phase 65 deliverables are gated by V-65-01..V-65-14 in this validator.
