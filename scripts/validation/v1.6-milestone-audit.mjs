...
//   C16: 4-edge cross-link integrity triangle (BLOCKING from Phase 62 D-A9)
//
// Usage: node scripts/validation/v1.6-milestone-audit.mjs [--verbose] [--self-test]
...
// milestone-close SHA (V16 = 9d8877c, see _lib/frozen-at-close.mjs MILESTONE_CLOSE_SHAS for the
// pin) instead of live HEAD, resolving the frozen-vs-evolved freshness mismatch.
const MILESTONE_TAG = 'V16';
const SIDECAR_PATH = 'scripts/validation/v1.6-audit-allowlist.json'; // UNCHANGED literal -- GOV-02
