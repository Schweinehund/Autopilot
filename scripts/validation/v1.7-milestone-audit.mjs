#!/usr/bin/env node
// v1.7 Milestone Audit Harness (Path A copy of v1.6; lineage v1.4 → v1.4.1 → v1.5 → v1.6 → v1.7; C1-C16 inherited verbatim)
// Source of truth: .planning/phases/70-v1-7-audit-harness-lineage-bump-milestone-close-pillar-d-clo/70-CONTEXT.md (D-01..D-04)
// Sidecar allow-list: scripts/validation/v1.7-audit-allowlist.json (v1.7 Path-A from v1.6 with c13_rotting_external reset for v1.7 per Phase 67 SWEEP-01/02 close-state)
...
//   C16: 4-edge cross-link integrity triangle (BLOCKING from Phase 62 D-A9)
//
// Usage: node scripts/validation/v1.7-milestone-audit.mjs [--verbose] [--self-test]
...
// milestone-close SHA (V17 = aa6de68, see _lib/frozen-at-close.mjs MILESTONE_CLOSE_SHAS for the
// pin) instead of live HEAD, resolving the frozen-vs-evolved freshness mismatch.
const MILESTONE_TAG = 'V17';
const SIDECAR_PATH = 'scripts/validation/v1.7-audit-allowlist.json'; // UNCHANGED literal -- GOV-02
                                                                      // pins (check-phase-70)
