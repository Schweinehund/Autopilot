...
// Sidecar allow-list: scripts/validation/v1.9-audit-allowlist.json (v1.9 Path-A from v1.8 with c13_rotting_external reset for v1.9 per Phase 82 close-state)
...
//   C16: 4-edge cross-link integrity triangle (BLOCKING from Phase 62 D-A9)
//
// Usage: node scripts/validation/v1.9-milestone-audit.mjs [--verbose] [--self-test]
...
// milestone-close SHA (V19 = b29dca5, see _lib/frozen-at-close.mjs MILESTONE_CLOSE_SHAS for the
// pin) instead of live HEAD, resolving the frozen-vs-evolved freshness mismatch.
const MILESTONE_TAG = 'V19';
const SIDECAR_PATH = 'scripts/validation/v1.9-audit-allowlist.json'; // UNCHANGED literal -- GOV-02
