...
//
// Usage: node scripts/validation/v1.16-milestone-audit.mjs [--verbose] [--self-test]
...
// milestone-close SHA (V116 = 3dd2512, see _lib/frozen-at-close.mjs MILESTONE_CLOSE_SHAS for the
...
const MILESTONE_TAG = 'V116';
const SIDECAR_PATH = 'scripts/validation/v1.16-audit-allowlist.json'; // UNCHANGED literal -- GOV-02
