...
<!-- No active milestone. v1.11 SHIPPED & ARCHIVED 2026-06-26 — 15/15 requirements Validated. Run /gsd-new-milestone to scope the next; a fresh REQUIREMENTS.md is created for the next cycle. -->

*No active milestone. **v1.11 macOS PSSO End-to-End Provisioning & MDM Migration SHIPPED & ARCHIVED 2026-06-26** (tag `v1.11`) — 5 phases (89-93), 13 plans, 15/15 requirements Validated. Deferred to v1.12+: three Phase-90 research gaps (INTUNE-PROFILE-ENROLLMENT-01, IRU-CONSOLE-DELETE-01, SUPERVISION-STATUS-POST-MIGRATION-01), WINDOWS-CLONE-DEEPNEST-TIMEOUT-01 (carried, now depth [48..92]; mitigated by D-03 — Linux GHA apex authoritative), and all v1.10 carried Part-B deferrals (MTPSSO-01/02/03, KRBFUT-01/02). Run `/gsd-new-milestone` to scope the next milestone.*
