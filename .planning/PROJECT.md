...
<!-- v1.12 ACTIVE — macOS MDM-Migration Verification Closure. Requirements defined in REQUIREMENTS.md (this milestone cycle). -->

***v1.12 macOS MDM-Migration Verification Closure — ACTIVE (started 2026-06-26).*** Closing the three Phase-90 post-migration verification gaps in `docs/macos-lifecycle/02-mdm-migration-psso.md` (INTUNE-PROFILE-ENROLLMENT-01, IRU-CONSOLE-DELETE-01, SUPERVISION-STATUS-POST-MIGRATION-01) + the 10th Path-A audit-harness lineage bump. Scope locked via `/adversarial-review` → **1-A / 2-A / 3-iii**. Requirements: see `.planning/REQUIREMENTS.md`. Phase numbering continues → Phase 94+.
