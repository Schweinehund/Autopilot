...
---
*Last updated: 2026-05-21 — v1.6 milestone in progress: Apple Business Delegated Governance & Multi-Org Operations across iOS/iPadOS + macOS. Scope locked at one Apple Business account with OUs (formerly Locations) and/or per-team custom roles (Q2 b/c + combination); Apple Business surface only (Intune-side RBAC out of scope); rebrand handling via glossary + 2 intro callouts only (Q5 b, no corpus sweep); cross-platform iOS+macOS merged docs tree. v1.5 shipped 2026-05-07 (14 phases, 101 plans, 57/57 reqs). Phase numbering continues 61 → v1.6 spans Phases 62-66. **Progress:** Phase 62 (Foundation & Rebrand) complete; Phase 63 (Multi-OU Architecture & Apple Admin Setup) complete 2026-05-21 — OU-01..OU-10 validated (8 admin-setup docs 03-10 + 3 iOS-matrix rows + check-phase-63.mjs validator). Next: Phase 64 (Apple Business Delegation Runbooks).*
