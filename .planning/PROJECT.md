...
**Pillar A — Archive-Automation Root-Cause (ARCHIVE-01 + ARCHIVE-02):**
- [ ] **ARCHIVE-01**: Root-cause fix in `.claude/commands/gsd-complete-milestone.md` (or `gsd-sdk query milestone.complete` handler) extraction-pattern logic emitting placeholder-label garbage into MILESTONES.md milestone-close entries
- [ ] **ARCHIVE-02**: Historical residue sweep across MILESTONES.md v1.0..v1.4.1 (v1.2 known 3-line `One-liner:` residue)
