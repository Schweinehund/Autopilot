...
---
*Last updated: 2026-05-20 — v1.6 milestone started 2026-05-20: Apple Business Delegated Governance & Multi-Org Operations across iOS/iPadOS + macOS. Scope locked at one Apple Business account with Locations and/or per-team custom roles (Q2 b/c + combination); Apple Business surface only (Intune-side RBAC out of scope); rebrand handling via glossary + 2 intro callouts only (Q5 b, no corpus sweep); cross-platform iOS+macOS merged docs tree. v1.5 shipped 2026-05-07 (14 phases, 101 plans, 57/57 reqs). Phase numbering continues 61 → v1.6 spans Phases 62+. Next: requirements definition + roadmap inside `/gsd-new-milestone` continuation.*
