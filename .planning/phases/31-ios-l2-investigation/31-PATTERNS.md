...
| `docs/l2-runbooks/17-ios-ade-compliance-ca-timing.md` | l2_runbook_new | doc_authoring | `docs/l2-runbooks/13-macos-compliance.md` (217 lines, verified) | role-match (step-numbered on macOS; iOS adopts D-14 hybrid axis structure `Investigation by Axis → Per-Cause Deep-Dive`) |
...
| `docs/l1-runbooks/21-ios-compliance-blocked.md` | 179 | `See [iOS L2 Runbooks (Phase 31)](../l2-runbooks/00-index.md) for advanced compliance / CA investigation (Phase 31 placeholder).` | `See [Compliance & CA Timing Investigation](../l2-runbooks/17-ios-ade-compliance-ca-timing.md) for advanced compliance / CA investigation (Cause A → timing axis; Causes B and C → config-error axis).` |
