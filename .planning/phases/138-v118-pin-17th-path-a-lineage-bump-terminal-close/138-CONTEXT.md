...
- **D-23: The new `audit-harness-v1.19-integrity.yml` `paths:` filter MUST list `.planning/milestones/v1.19-DEFERRED-CLEANUP.md`** (and `v1.19-MILESTONE-AUDIT.md`, and `.planning/REQUIREMENTS.md`), mirroring v1.18's. Omitting it silently narrows the trigger surface.
