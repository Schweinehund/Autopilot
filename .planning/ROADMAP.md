...
- [ ] **Phase 66: Apple Business Validation Tooling Closure + Milestone Audit** — C11 keyword extension + C15 banned-phrase refinement + BASELINE_10 refresh (closes BASELINE_9) + per-phase validators check-phase-62..66.mjs + CI workflow + terminal re-audit from fresh worktree + v1.6-MILESTONE-AUDIT.md + DEFERRED-CLEANUP.md
...
**Plans:** 5 plans
- [ ] 66-01-PLAN.md — Wave 1: check-phase-66.mjs scaffold (Path-A from check-phase-65.mjs; V-66-NN assertions + V-66-ABAUDIT-STALENESS) + 24 ABAUDIT exemption staleness walk across 11 files
- [ ] 66-02-PLAN.md — Wave 2: AUDIT-14 ATOMIC harness commit (4-5 files indivisible: v1.6-milestone-audit.mjs C11+regex-7 / v1.6-audit-allowlist.json c13_rotting_external populated / regenerate-supervision-pins.mjs BASELINE_10 / check-phase-66.mjs / probable check-phase-62.mjs V-62-SIDECAR extension); mandatory pre-commit dry-run loop per D-01 LOCKED
...
*Last updated: 2026-05-20 — v1.6 roadmap drafted. 5 phases (62-66), 39 requirements mapped, 100% coverage. Next: `/gsd-plan-phase 62`.*
