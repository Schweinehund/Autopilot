...
- [x] 144-06-PLAN.md — 18th Path-A harness + `v1.20-audit-allowlist.json` + BASELINE_24 + pin-drift adjudication

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 144-07-PLAN.md — apex `check-phase-144.mjs` `[48..143]`, four module-load guards, literal archive-root token

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 144-08-PLAN.md — 17th CI coexistence workflow (born `fetch-depth: 0`) + both stale-figure corrections

**Wave 7** *(blocked on Wave 6 completion)*

- [x] 144-09-PLAN.md — pre-push readiness census + OWNER checkpoint (push, dispatch, atom-branch disposition)
...
- [x] 144-11-PLAN.md — `v1.20-MILESTONE-AUDIT.md` + deferred-cleanup absorb-and-append (Part A/B/C)
