...
- [x] 125-01-PLAN.md — Wave-0 pre-anchor + flag-#6 full-chain scoping run + V115 positive-confirm (29a3599) + sidecar byte-unchanged recon
...
- [x] 125-04-PLAN.md — 3-axis re-audit + 9-workflow cascade RED scan + predecessor-byte-unchanged HARD gate
...
- [x] 125-06-PLAN.md — PIPE-02 owner-run grounding confirmation (retargeted v1.16-delta probes; autonomous:false)
