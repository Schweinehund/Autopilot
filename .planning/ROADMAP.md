...
- [x] 119-04-PLAN.md — 3-axis terminal re-audit: authoritative Axis-2 Linux GHA (both chain validators) + Axis-1 fresh clone + Axis-3 fresh sub-agent, cross-OS EXACT MATCH; predecessor-byte-unchanged HARD gate EMPTY (HARN-02, HARN-04)
