...
**Plans:** 3 plans
- [ ] 67-01-PLAN.md — Wave 1: SWEEP-01 ABM URL live-state verification (branchable; markdown-link-check@3.14.2 + corroborating curl HEAD; sidecar last_revalidated:2026-05-26 annotation; Branch A OR Branch B per Apple URL state)
