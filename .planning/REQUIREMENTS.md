...
- [x] **MIGF-02**: An admin can follow source-MDM-specific release steps for **Jamf Pro + Mosyle** (FileVault key retrieval, Activation Lock bypass, device-record deletion) as an addendum to `docs/macos-lifecycle/02-mdm-migration-psso.md`.
