...
- [x] **AEL2-02**: L2 Desktop Engineering can investigate an Android work profile enrollment failure (`docs/l2-runbooks/19-android-enrollment-investigation.md`) with structured diagnostic steps
- [x] **AEL2-03**: L2 Desktop Engineering can investigate an Android app install failure (`docs/l2-runbooks/20-android-app-install-investigation.md`) covering Managed Google Play app states, license assignment, and MAM intersection
- [x] **AEL2-04**: L2 Desktop Engineering can investigate Android compliance and Conditional Access timing (`docs/l2-runbooks/21-android-compliance-investigation.md`) using Play Integrity verdicts (not SafetyNet — deprecated January 2025)
