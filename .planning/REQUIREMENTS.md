...
- [ ] **AEAUDIT-02**: Expand audit allow-list sidecar from ~10 to ~37 pins for legitimate iOS-attributed supervision bridge-prose references in `docs/_glossary-android.md` + `docs/reference/android-capability-matrix.md` Cross-Platform Equivalences section
