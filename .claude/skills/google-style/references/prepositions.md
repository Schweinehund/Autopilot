...
_Source: https://developers.google.com/style/prepositions_
...
For information about which preposition to use when referring to UI elements, see [UI elements and interaction](ui-elements.md#prepositions).
