...
_Source: https://developers.google.com/style/headings-targets_

This page discusses how to turn a heading into a link target by using an `id` attribute. For more information about how to format headings, see [Headings and titles](headings.md).
