...
_Source: https://developers.google.com/style/dashes_

This page explains when to use em dashes. For information about hyphens, see the following:

- [Hyphens](hyphens.md)
- [Ranges of numbers](numbers.md#ranges-of-numbers)
...
Alternatively, press . Let go of those keys, and then type . Then press .
...
Windows  
Turn num lock on, and then hold down the left  key and type  on the numeric keypad.
