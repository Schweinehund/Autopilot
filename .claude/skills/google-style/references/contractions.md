...
_Source: https://developers.google.com/style/contractions_

In general, we write our documentation in an [informal tone](tone.md), so we recommend using common two-word contractions such as *you're*, *don't*, and *there's*.
