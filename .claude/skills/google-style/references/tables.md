...
_Source: https://developers.google.com/style/tables_
...
|----|----|----|
| Each item is a single unit. | A list of programming language names, or a list of steps to follow. | Use a [numbered list, lettered list, or bulleted list](lists.md#numbered-lettered-bulleted-lists). |
| Each item is a pair of pieces of related data. | A list of term/definition pairs. | Use a [description list](lists.md#description-lists) (or, in some contexts, a table). |
...
<tbody>
<tr>
<td><code translate="no" dir="ltr">href</code></td>
<td>HTML</td>
<td><p>Defines the URL for a link.</p>
<p>For example, go to the <code translate="no" dir="ltr">&lt;a href="https://www.google.com"&gt;Google Search&lt;/a&gt;</code> page.</p></td>
</tr>
<tr>
<td><code translate="no" dir="ltr">src</code></td>
<td>HTML</td>
<td><p>Defines the path of the image to be displayed.</p>
<p>For example, <code translate="no" dir="ltr">&lt;img src="kitten.jpg"&gt;</code>.</p></td>
</tr>
</tbody>
</table>
...
For more information, see the [Tables](accessibility.md#tables) section of the "Accessibility" page.
...
- Avoid using footnotes when possible. If your table does refer to footnotes, place them immediately following the table. For more information, see [Footnotes](footnotes.md).
