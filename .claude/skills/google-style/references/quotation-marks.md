...
_Source: https://developers.google.com/style/quotation-marks_
...
Generally, you can use quotation marks for titles of shorter works such as articles or episodes in a web series, unless they're part of a link. For more information, see [cross-references](cross-references.md).
...
For more information, see [Text-formatting summary](text-formatting.md).
...
**Note**: For information about how to use quotation marks with links, see [Quotation marks and italics](cross-references.md#quotation-marks-italics).
