...
_Source: https://developers.google.com/style/parentheses_
...
Don't use parentheses to indicate optional plurals. For more information, see [Plurals in parentheses](pluralization.md#plurals-in-parentheses).
