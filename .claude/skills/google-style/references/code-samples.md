...
_Source: https://developers.google.com/style/code-samples_
...
 (ending with a period): The following code sample shows how to use the `get` method. For information about other methods, see \[link\]. \[sample\]

: The following code sample shows how to use the `get` method: \[sample\] For information about other methods, see \[link\].

 (ending with a colon): The following code sample shows how to use the `get` method. For information about other methods, see \[link\]: \[sample\]

For more information about how to introduce code samples, see [Document command-line syntax](code-syntax.md).
