...
_Source: https://developers.google.com/style/tone_
...
- Buzzwords or [technical jargon](jargon.md).
- Being too cutesy.
- [Avoid figurative language](inclusive-documentation.md#figurative-language), which includes metaphors and ableist language.
- Placeholder phrases like *please note* and *at this time.*
- Choppy or long-winded sentences.
- Starting all sentences with the same phrase (such as *You can* or *To do*).
- Current pop-culture references.
- Exclamation marks. In general, avoid exclamation points. See [Specific guidance on exclamation points](periods.md#exclamation-points).
...
- Internet slang, or other [internet abbreviations](abbreviations.md#dont-use) such as *[tl;dr](word-list.md#tldr)* or *[ymmv](word-list.md#ymmv)*.
