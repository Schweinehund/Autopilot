...
_Source: https://developers.google.com/style/examples_

Don't use real domain names, email addresses, or people's names in your examples. Don't reveal personally identifiable information (PII), such as domain names, email addresses, phone numbers, people's names, project names, or credit card numbers. You can provide imaginary (fictitious) examples or use [placeholders](placeholders.md), like `USER_ID` or `EMAIL_ADDRESS`.
...
For further guidance, see the section of this guide on [writing inclusive documentation](inclusive-documentation.md).
...
For information about formatting, see [Format phone numbers in HTML or Markdown](phone-numbers.md#format-phone-numbers).
...
: The allow policy shows the identifier `deleted:serviceAccount:my-service-account@my-project.iam.gserviceaccount.com?uid=123456789012345678901`.
