...
_Source: https://developers.google.com/style/prescriptive-documentation_
...
- **Sample commands**. Prescriptive documentation provides commands and arguments that accomplish the task for the most common use case. For more information about documenting command-line options, see [Optional arguments in click-to-copy commands](code-syntax.md#click-to-copy-commands).
...
: Ensure that the Classroom Share Button conforms to our min-max size guidelines and related color/button templates.

: The column of the data table that the filter operates on.

: Whether it's a brand new project or an existing one, perform the following steps.

: The Classroom Share Button should conform to our min-max size guidelines and related color and button templates.

: The column of the data table that the filter should operate on.

: Whether it's a brand new project or an existing one, here's what you should do.

## More resources

- See also [can](word-list.md#can), [could](word-list.md#could), [may](word-list.md#may), [might](word-list.md#might), [must](word-list.md#must), and [would](word-list.md#would) in the word list.
