...
| Apple TV management | N/A | N/A | 🔒 supervised only — ADE path (business-channel purchase via Apple reseller/Business Store) or Configurator path (retail purchase); OU-scoped device pool; see 10-apple-tv-lifecycle.md |
